...
@interface DTNavigationController () <UINavigationControllerDelegate>
{
    UIView *blockView;
...
- (void)viewDidLoad
{
    ...
    [_folderBar.actionButton addTarget:self action:@selector(actionButtonClick) forControlEvents:UIControlEventTouchUpInside];
...
- (void)actionButtonClick{
    if ([self.DTDelegate respondsToSelector:@selector(navigationControllerActionButtonClick)]) {
        [self.DTDelegate navigationControllerActionButtonClick];
    }
}
